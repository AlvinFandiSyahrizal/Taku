...
<div class="form-grid">
    ...
    <div class="form-group">
        ...
        @include('admin.products._category_select', ['selectedId' => old('category_id')])
    ...
    <div class="form-group">
        ...
        <input type="number" name="discount_percent" class="form-input" value="{{ old('discount_percent', 0) }}" min="0" max="100" placeholder="0">
    ...
    <div class="form-group">
        ...
        <p class="form-hint">Stok untuk produk tanpa variasi.</p>
    </div>

    <div class="form-group">
        <label class="form-label">Featured</label>
        <div class="toggle-wrap" style="margin-top:10px;">
            <input type="checkbox" name="is_featured" class="toggle" id="isFeatured" {{ old('is_featured') ? 'checked' : '' }}>
    ...
    <div class="form-group full" style="background:#fafaf8;border:.5px solid rgba(11,42,74,.07);border-radius:12px;padding:20px 24px;">
        @include('admin.products._variant_builder', ['product' => null])
    </div>
